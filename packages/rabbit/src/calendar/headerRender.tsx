...
export default function HeaderRender({ date, mode, baseMode, onChangeDate, onChangeMode }: CalendarHeaderRenderProps) {
  const tenYearOptions: SelectOptionType<number>[] = useMemo(() => {
  ...
  const centuryOptions: SelectOptionType<number>[] = useMemo(() => {
  ...
  const yearOptions: SelectOptionType<number>[] = useMemo(() => {
  ...
  const monthOptions: SelectOptionType<number>[] = useMemo(() => {
