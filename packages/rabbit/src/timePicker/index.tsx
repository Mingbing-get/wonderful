  ...
  const handleBlur = useCallback(
    (text: string) => {
      ...
      setValue((oldValue) => {
        ...
        if (newValue.hour() === oldValue?.hour() && newValue.minute() === oldValue?.minute() && newValue.second() === oldValue?.second()) return oldValue
    ...
    <Popover
      ...
      content={
        <div className="rabbit-time">
          ...
          />
          {renderExtraFooter ? (
            <div className="rabbit-time-footer">{renderExtraFooter()}</div>
          ) : (
            showNow && (
