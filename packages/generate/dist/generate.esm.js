...
var Generate = /*#__PURE__*/function () {
  ...
  _createClass(Generate, [{
    ...
    key: "initRecorder",
    value: function initRecorder(canvas) {
      var _this2 = this;
    ...
    key: "setRecordBox",
    value: function setRecordBox(box) {
      this.recordBox = box;
    }
  }, {
    key: "start",
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                _context2.next = 4;
                return html2canvas(this.recordBox);
              case 4:
    ...
    key: "generateByServe",
    value: function generateByServe() {
    ...
    value: function download() {
      var url = URL.createObjectURL(new Blob(this.data, {
        type: "video/".concat(this.type)
      }));
